                ...
                <section className='px-6 py-16 bg-green-100'>
                    <div className='max-w-screen-lg mx-auto'>
                            ...
                            {[
                                {
                                    ...
                                    answer: "Elevate Hub is plateform designed to connect ambitious individuals with expert mentor to help them"
                                },
                        ...
                        <div className='mt-12 text-center'>
                            <button className='px-8 py-4 text-lg font font-semibold text-white rounded-lg bg-gray-400  cursor-not-allowed '
                                disabled >
